      ...
      <div class="loginInner">
        <div class="login_header">
          ...
          <div class="login_header_title">
            <a href="javascript:;" :class="this.isPhone" @click="isShow=true">短信登录</a>
            <a href="javascript:;" :class="this.isUser" @click="isShow=false">密码登录</a>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      isPsw:function () {
        return this.inHide?"tel":"password"
      },
      switchBtn:function () {
        return this.inHide?"on":""
      },
      isRightPhone:function () {
        return /^((13|14|15|17|18)[0-9]{1}\d{8})$/.test(this.phone)
      },
      isRightPhoneSyt:function () {
        return (/^((13|14|15|17|18)[0-9]{1}\d{8})$/.test(this.phone))?'on':'off'
      }
    }
  }
</script>
