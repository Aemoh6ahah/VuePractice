<template>
    <div class="shop-header">
        ...
        <div class="shop-content">
            <img :src="$store.state.shopList.length?`https://fuss10.elemecdn.com`+$store.state.shopList[$route.query.index].image_path:''" alt="loading" class="content-image">
            <div class="header-content">
                <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
                    <span class="content-name">{{$store.state.shopList.length?$store.state.shopList[$route.query.index].name:'正在加载'}}</span>
<!--                    <span class="content-name"> {{$store.state.shopList.length?$store.state.shopList[$store.state.shopIndex].name:'正在加载'}}</span>-->
...
<script>
    export default {
        ...
        mounted() {
            ...
            // console.log(this.$store.state.shopList[this.$route.query.index].name)
